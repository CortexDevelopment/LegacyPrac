...
public enum Locale {
    ...
    PARTY_INFO("PARTY.INFO", Legacy.asList(package xyz.refinedev.practice;

import lombok.Getter;
import xyz.refinedev.practice.util.chat.CC;
import xyz.refinedev.practice.util.config.impl.BasicConfigurationFile;

import java.util.LegacyList;
import java.util.Legacys;
import java.util.Collections;
import java.util.List;
...
public enum Locale {
    ...
    PARTY_INVITED("PARTY.INVITED", "&7[&bParty&7] &7You have been invited to join &b<leader>'s &7party."),
    PARTY_CLICK_TO_JOIN("PARTY.CLICK_TO_JOIN", "&7[&bParty&7] &b(Click to accept)"),
    PARTY_INVITE_HOVER("PARTY.INVITE_HOVER", "&aClick to to accept this party invite"),
    PARTY_PLAYER_INVITED("PARTY.PLAYER_INVITED", "&7[&bParty&7] &b<invited> &7has been invited to your party."),
    PARTY_PLAYER_JOINED("PARTY.PLAYER_JOINED", "&7[&bParty&7] &b<joiner> &7joined your party."),
    PARTY_PLAYER_LEFT("PARTY.PLAYER_LEFT", "&7[&bParty&7] &b<leaver> &7has left your party."),
    PARTY_PLAYER_KICKED("PARTY.PLAYER_KICK", "&7[&bParty&7] &b<leaver> &7has been kicked from your party."),
    PARTY_CREATED("PARTY.CREATED", "&7[&bParty&7] &aYou created a party."),
    PARTY_DISBANDED("PARTY.DISBANDED", "&7[&bParty&7] &bYour party has been disbanded."),
    PARTY_PUBLIC("PARTY.PUBLIC", "&7[&bParty&7] &b<host> &ais hosting a public party"),
    PARTY_PRIVACY("PARTY.PRIVACY", "&7[&bParty&7] &7Your party privacy has been changed to &b<privacy>"),
    PARTY_PROMOTED("PARTY.PROMOTED", "&7[&bParty&7] &b<promoted> &ahas been promoted to Leader in your party."),
    PARTY_DONOTHAVE("PARTY.DO_NOT_HAVE", "&7[&bParty&7] &7You don't have a party!"),
    PARTY_CHAT_FORMAT("PARTY.CHAT_FORMAT", "&7[&bParty&7] &b<player_name> &7» &f<message>"),
    PARTY_ALREADYINVITED("PARTY.ALREADY_INVITED", "&7[&bParty&7] &7That player has already been invited to your party."),
    PARTY_WRONG_LEADER("PARTY.DONT_HAVE_PARTY", "&7[&bParty&7] &7That player does not have a party."),
    PARTY_HCF_UPDATED("PARTY.HCF_CLASS_CHANGE", "&7[&bParty&7] &b<target>'s &7HCF Class was changed to &b<class>&7."),
    PARTY_NOT_INVITED("PARTY.NOT_INVITED", "&7[&bParty&7] &7You are not invited to this party."),
    PARTY_TOURNAMENT("PARTY.IN_TOURNAMENT", "&7[&bParty&7] &7That party is currently in a tournament."),
    PARTY_FULL("PARTY.FULL", "&7[&bParty&7] &7That party is currently full!"),
    PARTY_NOTLEADER("PARTY.NOTLEADER", "&7[&bParty&7] &7You are not the leader of this party!"),
    PARTY_NOT_MEMBER("PARTY.NOT_MEMBER", "&7[&bParty&7] &7That player is not a member of this party."),
    PARTY_NOT_BANNED("PARTY.NOT_BANNED", "&7[&bParty&7] &7That player is not banned from your party."),
    PARTY_BUSY("PARTY.BUSY", "&7[&bParty&7] &7Your party is currently busy, please try again later!"),
    PARTY_BAN_SELF("PARTY.BAN_SELF", "&7[&bParty&7] &7You can't ban yourself from your own party."),
    PARTY_UNBAN_SELF("PARTY.KICK_SELF", "&7[&bParty&7] &7You can't unban yourself from your own party."),
    PARTY_LEAVE_SELF("PARTY.LEAVE_SELF", "&7[&bParty&7] &7You can't leave your own party, please do /party disband."),
    PARTY_KICK_SELF("PARTY.KICK_SELFT", "&7[&bParty&7] &7You can't kick yourself from your own party."),
    PARTY_BANNED("PARTY.BANNED", "&7[&bParty&7] &7You have been banned from the party."),
    PARTY_BAN("PARTY.BAN", "&7[&bParty&7] &7Successfully banned &b<target> &7from the party."),
    PARTY_EVENT_NEED("PARTY.EVENT_REQUIRED", "&7[&bParty&7] &7You need at least 2 members to start an Event!"),
    PARTY_KICKED("PARTY.KICKED", "&7[&bParty&7] &7You have been kicked from the party."),
    PARTY_UNBANNED("PARTY.UNBANNED", "&7[&bParty&7] &b<target> &7has been unbanned from the party."),
    PARTY_ALREADYHAVE("PARTY.ALREAD_HAVE", "&7[&bParty&7] &7You already have a party!"),
    PARTY_ALREADYLEADER("PARTY.ALREADY_LEADER", "&7[&bParty&7] &7You are already the leader of your party."),
    PARTY_ALREADYINPARTY("PARTY.ALREADY_JOINED", "&7[&bParty&7] &7That player is already in your party."),
    PARTY_ALREADYBANNED("PARTY.ALREADY_BANNED", "&7[&bParty&7] &7That player is already banned from your party."),
    PARTY_IN_TOURNAMENT("PARTY.IN_TOURNAMENT", "&7[&bParty&7] &7Your party is currently in a tournament!"),
    PARTY_CHAT("PARTY.ENABLED_CHAT", "&aYou are now speaking in party chat!"),
    PARTY_GLOBAL("PARY.DISABLED_CHAT", "&aYou are now speaking in global chat!"),
    PARTY_INFO("PARTY.INFO", Legacy.asList(
            "&b&m--------&7&m-------------------------------------&b&m--------",
            "&bParty Information", "&b&m--------&7&m-------------------------------------&b&m--------",
            "&8 \u2022 &bLeader: <party_leader_name>",
            "&8 \u2022 &bPrivacy: <party_privacy>",
            "&8 \u2022 &bMembers: <party_members_formatted>",
            "&b&m--------&7&m-------------------------------------&b&m--------")),
    PARTY_DONATOR("PARTY.DONATOR_MESSAGE", Legacy.asList(
            "&7You do not have permission to use Party Settings.",
            "&7&oPlease upgrade your core at &b&o<store>&7")),
    PARTY_HELP("PARTY.HELP_MESSAGE", Legacy.asList(
            "&b&m--------&7&m-------------------------------------&b&m--------",
            "&bParty Commands",
            "&b&m--------&7&m-------------------------------------&b&m--------",
            " &8\u2022 &b/party help &8(&7&oDisplays the help message&8)",
            " &8\u2022 &b/party create &8(&7&oCreates a party instance&8)",
            " &8\u2022 &b/party leave &8(&7&oLeave your current party&8)",
            " &8\u2022 &b/party info &8(&7&oDisplays your party information&8)",
            " &8\u2022 &b/party join &8<&7leader&8> &8(&7&oJoin a party&8)",
            " &8\u2022 &b/party chat &8(&7&oToggle party chat&8)",
            " &8\u2022 &b/party event &8(&7&oOpen Party Events Menu&8)",
            " &8\u2022 &b/party settings &8(&7&oOpen Party Settings Menu&8)",
            " &8\u2022 &b/party open &8(&7&oOpen your party for others to join&8)",
            " &8\u2022 &b/party close &8(&7&oClose your party for others to join&8)",
            " &8\u2022 &b/party invite &8<&7profile&8> &8(&7&oInvites a profile to your party&8)",
            " &8\u2022 &b/party kick &8<&7profile&8> &8(&7&oKicks a profile from your party&8)",
            " &8\u2022 &b/party ban &8<&7profile&8> &8(&7&oBans a profile from your party&8)",
            " &8\u2022 &b/party unban &8<&7profile&8> &8(&7&oUnbans a profile from your party&8)",
            " &8\u2022 &b/party promote &8<&7profile&8> &8(&7&oTransfers Ownership of your party&8)",
            "&b&m--------&7&m-------------------------------------&b&m--------")),

    CLAN_INVITED("CLAN.INVITED", "&7[&bClan&7] &7You have been invited to join &b<leader>'s &7clan."),
    CLAN_CLICK_TO_JOIN("CLAN.CLICK_TO_JOIN", "&7[&bClan&7] &b(Click to accept)"),
    CLAN_INVITE_HOVER("CLAN.INVITE_HOVER", "&aClick to to accept this clan invite"),
    CLAN_NAME_LENGTH("CLAN.NAME_LENGTH", "&7[&bClan&7] &7Clan names must be greater than or equal to 2 characters long and less than or equal to 8 characters long."),
    CLAN_NAME_LETTER("CLAN.NAME_LETTER", "&7[&bClan&7] &7Clan names must only contain alpha characters (letters only)."),
    CLAN_ALREADY_PARTOF("CLAN.ALREADY_PARTOF", "&7[&bClan&7] &7You are already part of &b<clan_name> &7Clan!"),
    CLAN_NAME_ALREADYEXIST("CLAN.ALREADY_EXISTS", "&7[&bClan&7] &7A clan with the name &b<name> &7already exists!"),
    CLAN_CREATED("CLAN.CREATED", "&7[&bClan&7] &7You created a &bClan &7with the name &b<name>&7, use &b/clan invite <profile> &7to invite members."),
    CLAN_DOESNT_EXIST("CLAN.DOES_NOT_EXIST", "&7[&bClan&7] &7That clan does not exist!"),
    CLAN_PASSWORD_REQURED("CLAN.PASSWORD_REQUIRED", "&7[&bClan&7] &7You need the password or an invitation to join this clan.\nTo join with a password, use &b/clan join <clan_name> <password> &7."),
    CLAN_INCORRECT_PASS("CLAN.INCORRECT_PASSWORD", "&7[&bClan&7] &7Incorrect Password!"),
    CLAN_NOT_LEADER("CLAN.NOT_LEADER", "&7[&bClan&7] &7You are not the leader of any Clan!"),
    CLAN_NOT_PARTOF("CLAN.NOT_PART_OF", "&7[&bClan&7] &7That player is not a part of your Clan!"),
    CLAN_DISBANDED("CLAN.DISBANDED", "&7[&bClan&7] &bYour clan has been disbanded by the Leader!"),
    CLAN_INVITE_SELF("CLAN.INVITE_SELF", "&7[&bClan&7] &7You can not invite yourself!"),
    CLAN_DONOTHAVE("CLAN.DO_NOT_HAVE", "&7[&bClan&7] &7You are not part of any clan!"),
    CLAN_DOESNOTHAVE("CLAN.DOES_NOT_HAVE", "&7[&bClan&7] &7That player is not part of any clan!"),
    CLAN_ALREADYHAVE("CLAN.ALREADY_HAVE", "&7[&bClan&7] &7That player already has a Clan!"),
    CLAN_ALREADYINVITED("CLAN.ALREADY_INVITED", "&7[&bClan&7] &7That player has already been invited!"),
    CLAN_INVITED_BROADCAST("CLAN.INVITE_BROADCAST", "&7[&b&lClan&7] &b<invited> &7has been invited to the clan!"),
    CLAN_IN_FIGHT("CLAN.IN_FIGHT", "&7[&b&lClan&7] &7A Clan member from your Clan is in a clan match, please wait before disbanding!"),
    CLAN_NOT_CAPTAIN("CLAN.NOT_CAPTAIN", "&7[&b&lClan&7] &7You are not the captain of any Clan!"),
    CLAN_SELF_PROMOTE("CLAN.SELF_PROMOTE", "&7[&b&lClan&7] &7You can't self promote!"),
    CLAN_KICKED("CLAN.KICKED_BROADCAST", "&7[&bClan&7] &b<player> &7has been kicked from the Clan!"),
    CLAN_BANNED("CLAN.BANNED_BROADCAST", "&7[&bClan&7] &b<player> &7has been banned from the Clan!"),
    CLAN_CHAT_ERROR("CLAN.CHAT_ERROR", "&8[&b&lClan&8] &7Your clan chat is currently enabled, please disable it first."),
    CLAN_JOIN("CLAN.JOINED", "&7[&bClan&7] &b<player> &7has joined the Clan!"),
    CLAN_PROMOTE("CLAN.PROMOTE", "&7[&bClan&7] &b<player> &7has been promoted to &b&l<role>&7!"),
    CLAN_DEMOTE("CLAN.DEMOTE", "&7[&bClan&7] &b<player> &7has been demoted to &b&l<role>&7!"),
    CLAN_LEFT("CLAN.LEFT", "&7[&bClan&7] &b<player> &7has left the Clan!"),
    CLAN_NO_PERM("CLAN.NO_PERM", "&7[&bClan&7] &7You do not have permission to execute this task!"),
    CLAN_SETDESC("CLAN.SET_DESC", "&7[&bClan&7] &7Successfully updated the &bdescription &7of your Clan!"),
    CLAN_SETPASS("CLAN.SET_PASS", "&7[&bClan&7] &7Successfully updated the &bpassword &7of your Clan!"),
    CLAN_LEADER_LEAVE("CLAN.LEADER_LEAVE", "&7[&bClan&7] &7The Leader can not leave the Clan, use &b/clan disband &7to disband your Clan!"),
    CLAN_IS_BANNED("CLAN.PLAYER_BANNED", "&7[&b&lClan&7] &7That player has been banned from this clan, use &b/clan unban <profile> &7to unban."),
    CLAN_CHAT_FORMAT("CLAN.CHAT_FORMAT", "&7[&b&lClan&7] &b<player_displayname> &7» &f<message>"),
    CLAN_HELP("CLAN.HELP_MESSAGE", Legacy.asList(
            "&b&m--------&7&m-------------------------------------&b&m--------",
            "&bClan Commands",
            "&b&m--------&7&m-------------------------------------&b&m--------",
            " &8\u2022 &b/clan create &8<&7name&8> &8(&7&oCreate a Clan&8)",
            " &8\u2022 &b/clan disband &8(&7&oDisband your Clan&8)",
            " &8\u2022 &b/clan chat &8(&7&oToggle your Clan Chat Mode&8)",
            " &8\u2022 &b/clan accept &8<&7leader&8> &8(&7&oAccept a Clan Invitation&8)",
            " &8\u2022 &b/clan leave &8(&7&oLeave your Current Clan&8)",
            " &8\u2022 &b/clan info &8(&7&oView information about your Clan&8)",
            " &8\u2022 &b/clan invite &8<&7profile&8> &8(&7&oInvite a Profile to your Clan&8)",
            " &8\u2022 &b/clan kick &8<&7profile&8> &8(&7&oKick a Profile from your Clan&8)",
            " &8\u2022 &b/clan ban &8<&7profile&8> &8(&7&oBan a Profile from your Clan&8)",
            " &8\u2022 &b/clan promote &8<&7profile&8> &8(&7&oPromote a Profile to Captain&8)",
            " &8\u2022 &b/clan demote &8<&7profile&8> &8(&7&oDemote a Profile to Member&8)",
            " &8\u2022 &b/clan leader &8<&7profile&8> &8(&7&oPromote a Profile to Leader&8)",
            " &8\u2022 &b/clan description &8<&7text&8> &8(&7&oSet your Clan's Description&8)",
            "&b&m--------&7&m-------------------------------------&b&m--------")),
    CLAN_INFO("CLAN.INFO", Legacy.asList(
            "&b&m--------&7&m-------------------------------------&b&m--------",
            "&b<clan_name> Information &8[&7<clan_members_size>/<clan_members_limit>&7]",
            "&b&m--------&7&m-------------------------------------&b&m--------",
            "&8 \u2022 &bLeader: &f<clan_leader>",
            "&8 \u2022 &bMembers: &f<clan_members>",
            "&8 \u2022 &bClan ELO: &f<clan_elo>",
            "&8 \u2022 &bDate Created: &f<clan_created>",
            "&8 \u2022 &bWinstreak | Highest WS: &f<clan_winstreak> &7\uff5c &f<clan_highest_winstreak>",
            "&b&m--------&7&m-------------------------------------&b&m--------")),

    ERROR_BUSY("ERROR.TARGET-BUSY", "&bThat player is currently busy, please try again."),
    ERROR_NOTABLE("ERROR.SELF-BUSY", "&bYou can not do this right now."),
    ERROR_NOTACTIVE("ERROR.NOT-ACTIVE", "&bThere is no current on-going event!"),
    ERROR_NOTPARTOF("ERROR.NOT-PARTOF", "&bYou are not part of any on-going event!"),
    ERROR_NO_ARENAS("ERROR.NO-ARENAS", "&bThere are no available arenas!"),
    ERROR_PEARLSDISABLED("ERROR.PEARLS-DISABLED", "&bYou can't enderpearl in this arena!"),
    ERROR_MENU("ERROR.MENU", "&bThat menu does not exist or you are not able to open the menu."),
    ERROR_PLAYERNOTFOUND("ERROR.PLAYER-NOT-FOUND", "&bThat player does not exist or is not currently online."),
    ERROR_TARGET_NOT_IN_MATCH("ERROR.TARGET-NOT-IN-MATCH", "&bThat player is currently not in a match!"),
    ERROR_SELF_NOT_IN_MATCH("ERROR.SELF-NOT-IN-MATCH", "&bYou are not in a match!"),
    ERROR_NOT_IN_QUEUE("ERROR.QUEUE.NOT-IN-QUEUE", "&bYou are not in a queue!"),
    ERROR_PING_TOO_HIGH("ERROR.QUEUE.PING-TOO-HIGH", "&bYour ping is too high, the ping limit is <ping_limit>!"),
    ERROR_FREE("ERROR.SPECTATE.FREE", "&bThat player is not in any match or any event."),
    ERROR_NOSPEC("ERROR.SPECTATE.NOT-ALLOWING", "&bThat player is not allowing spectators currently."),
    ERROR_NOTSPECTATING("ERROR.SPECTATE.NOT-SPECTATING", "&bYou are not spectating!"),
    ERROR_MATCHNOSPEC("ERROR.SPECTATE.NOSPEC", "&bThis match contains a player that is not allowing spectators currently."),
    ERROR_PARTY("ERROR.DUEL.SELF-IN_PARTY", "&bYou are currently in a party"),
    ERROR_TARGET_IN_PARTY("ERROR.DUEL.TARGET-IN-PARTY", "&bThe target is currently in a party."),
    ERROR_NO_PARTY_TO_DUEL("ERROR.DUEL.NO-PARTY-TO-DUEL", "&bYou don't have a party to duel with."),
    ERROR_TARGET_NO_PARTY("ERROR.DUEL.TARGET-NO-PARTY", "&bThe target does not have a party!"),
    ERROR_NOREMATCH("ERROR.DUEL.NO-REMATCH", "&bYou don't have anyone to rematch with!"),
    ERROR_REMATCHSENT("ERROR.DUEL.REMATCH-ALREADY-SENT", "&bYou have already sent the rematch request!"),
    ERROR_EXPIREREMATCH("ERROR.DUEL.REMATCH-EXPIRED", "&bYour rematch time has been expired!"),

    SETTINGS_ENABLED("SETTINGS.ENABLED", "&7You enabled &b<setting_name>&7 for your profile!"),
    SETTINGS_DISABLED("SETTINGS.DISABLED", "&7You disabled &b<setting_name>&7 for your profile!"),
    SETTING_NOPERM("ERROR.SETTINGS_NO_PERM", Legacy.asList(
            "&7You don't have permission to use this setting",
            "&7&oyou can upgrade your core at &b&o<store>&7&o.")
    ),

    RANKED_DISABLED("RANKED.DISABLED", "&bRanked has been disabled by an Admin!"),
    RANKED_REQUIRED("RANKED.REQUIRED", Legacy.asList(
            "&7You need to win at least &b<match_limit> Unranked Matches &7to queue Ranked!",
            "&7&oYou can bypass this limit by upgrading your rank at &b&o<store>")
    ),

    HCF_CLASS_ENABLED("HCF.CLASS_ENABLED", "&bClass: &f<class> &aenabled!"),
    HCF_COOLDOWN("HCF.COOLDOWN", "&bYou cannot use this for another <duration>!"),
    HCF_ARCHER_RANGE("HCF.ARCHER.RANGE", "&bRange: &f<range>"),
    HCF_ARCHER_MARKED("HCF.ARCHER.MARKED-SHOOTER", "&7You Marked &b<damaged> &7for &b10 seconds &b<damagedhealth> &4❤"),
    HCF_ARCHER_DAMAGEMARKED("HCF.ARCHER.MARKED-DAMAGED", "&7Marked! &b<shooter> &7has shot &byou &7and &bmarked &7you (+25% damage) for &b10 seconds&7. &8(&b<distance> blocks away&8)"),
    HCF_BARD_ENERGY("HCF.BARD.ENERGY", "&bBard Energy: &f<energy>"),
    HCF_BARD_BARDBUFF("HCF.BARD.BARD-BUFF", "&7You have just used a &b&lBard Buff &7that cost you &b<cost> &7of your Energy."),
    HCF_BARD_NOTENOUGHENERGY("HCF.BARD.NOT-ENOUGH-ENERGY", "&7You do not have enough energy for this! You need &b<cost> &7energy, but you only have &b<energy>&7!"),
    HCF_ROUGE_BACKSTABBED("HCF.ROUGE.BEEN-BACKSTABBED", "&b<attacker> &ehas backstabbed you!"),
    HCF_ROUGE_BACKSTABBER("HCF.ROGUE.HAVE-BACKSTABBED", "&eYou have backstabbed &b<target>&e."),

    MATCH_HCF_STARTMESSAGE("MATCH.START-MESSAGE.HCF", Legacy.asList(
            "&b&lHCF Match&7!",
            "",
            "&7Pick between &bBard&7, &bArcher&7, &bRogue&7 and &bDiamond", "&7Kits and Fight to the death to &bWin!", "")
    ),
    ...
    MATCH_ROUND_MESSAGE("MATCH.ROUND-MESSAGE", Legacy.asList(
            ...
            "  &fYour Points: &b<your_points>",
            "  &fTheir Points: &b<their_points>")
    ),
    ...
    MATCH_COUNTDOWN("MATCH.COUNTDOWN", "&b<seconds>&f..."),
    MATCH_STARTED("MATCH.STARTED", "&aMatch Started!"),
    MATCH_SPECTATE("MATCH.SPECTATE_JOIN", "&b<spectator> &eis now spectating your match!"),
    MATCH_STOPSPEC("MATCH.SPECTATE_LEAVE", "&b<spectator> &eis no longer spectating your match!"),
    ...
    MATCH_MAX_BUILD("MATCH.MAX_BUILD_LIMIT", "&bYou have reached the build height limit!"),
    MATCH_BOW_HIT("MATCH.BOW_HIT", "&b<damaged_name> &7is now at &b<damaged_health> &4\u2764"),
    MATCH_PEARL_COOLDOWN("MATCH.PEARL_COOLDOWN.CANNOT", "&bYou are on pearl cooldown for <cooldown>!"),
    MATCH_PEARL_COOLDOWN_EXPIRE("MATCH.PEARL_COOLDOWN.EXPIRE", "&bYou can now use enderpearls again."),
    MATCH_BOW_COOLDOWN("MATCH.BOW_COOLDOWN.CANNOT", "&bYou are on bow cooldown for <cooldown>!"),
    MATCH_BOW_COOLDOWN_EXPIRE("MATCH.BOW_COOLDOWN.EXPIRE", "&aYour bow cooldown has expired!"),
    MATCH_PLACE_BLOCK("MATCH.BLOCK_PLACE", "&bYou cannot place blocks here!"),
    MATCH_WRONG_PORTAL("MATCH.WRONG_PORTAL", "&bYou jumped in the wrong portal!"),
    MATCH_WRONG_BED("MATCH.WRONG_BED", "&bThis is your own bed, you dumbo!"),
    ...
    MATCH_INVENTORY_MESSAGE("MATCH.INVENTORY.MESSAGE", Legacy.asList(
            "&b&m--------&7&m-------------------------------------&b&m--------",
            "&b&lMatch Details &7(Click name to view inventory)",
            "",
            "<inventories>",
            "<elo_changes>",
            "&b&m--------&7&m-------------------------------------&b&m--------")
    ),
    MATCH_INVENTORY_HOVER("MATCH.INVENTORY.NAME-HOVER", "&7Click to view &b<inventory_name>'s &7inventory."),
    ...
    MATCH_INVENTORY_LOSER("MATCH.INVENTORY.SOLO-LOSER", "&bLoser: "),
    MATCH_INVENTORY_LOSERS("MATCH.INVENTORY.TEAM-LOSERS", "&bLosers: "),
    MATCH_ELO_CHANGES("MATCH.INVENTORY.ELO-CHANGE", "&a<winner_name> +<winner_elo_change> (<winner_elo>) &7⎜ &b<loser_name> -<loser_elo_change> (<loser_elo>)"),
    MATCH_SPEC_MESSAGE("MATCH.INVENTORY.SPEC-MESSAGE", "&bSpectators (<spec_size>): &7<spectators>"),
    MATCH_SWORD_DROP("MATCH.SWORD_DROP", "&bYou can't drop that while holding it in slot 1."),
    MATCH_BUILD_OUTSIDE("MATCH.BUILD_OUTSIDE", "&bYou cannot build outside of the arena!"),
    ...
    TOURNAMENT_ROUND("TOURNAMENT.ROUND_MESSAGE", "&7[&bTournament&7] &3Round #<round> &7is starting in <time>."),
    TOURNAMENT_CANCELLED("TOURNAMENT.CANCELLED", "&7[&bTournament&7] &bThe Tournament has been cancelled."),
    ...
    TOURNAMENT_ELIMINATED("TOURNAMENT.ELIMINATED", "&7[&bTournament&7] &bYou have been eliminated from the Tournament. You can see the status with /tournament status"),
    TOURNAMENT_TEAM_ELIMINATED("TOURMANENT.TEAM-ELIMINATED", "&7[&bTournament&7] &a<playerA>'s party &7has been eliminated by &b<playerB>'s party."),
    TOURNAMENT_PLAYER_ELIMINATED("TOURNAMENT.PLAYER-ELIMINATED", "&7[&bTournament&7] &a<playerA> &7has been eliminated by &b<playerB>."),
    TOURNAMENT_PLAYER_JOIN("TOURNAMENT.PLAYER-JOIN", "&7[&bTournament&7] &b<player> &7joined the tournament. &8(&b<players>/<maxPlayers>&8)"),
    TOURNAMENT_PLAYER_LEAVE("TOURNAMENT.PLAYER-LEAVE", "&7[&bTournament&7] &b<player> &7left the tournament. &8(&b<players>/<maxPlayers>&8)"),
    TOURNAMENT_REMAINING("TOURNAMENT.REMAINING", "&7[&bTournament&7] &b<players> &7remaining out of &b<maxPlayers>"),
    TOURNAMENT_WON("TOURNAMENT.WON", "&b<winners> &7won the &b<teamSize>&7v&b<teamSize> <kit> &7Tournament!"),
    TOURNAMENT_STARTED("TOURNAMENT.STARTED", Legacy.asList("&7[&bTournament&7] &7A &bTournament &7has started with kit &b<kit> &7and is on &bRound#<round>&7. (&b<teamSize>v<teamSize>&7)")),
    TOURNAMENT_FORCE_STARTED("TOURNAMENT.FORCE_STARTED", Legacy.asList("&7[&bTournament&7] &7The &bTournament &7has been force-started, starting in &b10 seconds&7.")),
    TOURNAMENT_ANNOUNCEMENT("TOURNAMENT.ANNOUNCEMENT", Legacy.asList("&7[&bTournament&7] &7A &bTournament &7is being hosted with kit &b<kit>&7. (&b<teamSize>v<teamSize>&7) &a[CLICK TO JOIN]")),
    TOURNAMENT_HELP("TOURNAMENT.HELP", Legacy.asList(
            "&b&m--------&7&m-------------------------------------&b&m--------",
            "&bLegacy &7» Tournament Commands",
            "&b&m--------&7&m-------------------------------------&b&m--------",
            " &8\u2022 &b/tournament list &8(&7&oList Active Tournaments&8)",
            " &8\u2022 &b/tournament host (team-size) &8(&7&oHost a tournament8&o)",
            " &8\u2022 &b/tournament cancel &8(&7&oCancel a tournament8&o) &8- &b&l[ADMIN]",
            " &8\u2022 &b/tournament join &8(&7&oJoin an on-going tournament8&o)",
            " &8\u2022 &b/tournament leave &8(&7&oLeave an on-going tournament8&o)",
            "&b&m--------&7&m-------------------------------------&b&m--------")),

    EVENT_PREFIX("EVENTS.PREFIX", "&7[&b<event_name>&7] &r"),
    EVENT_JOIN("EVENTS.JOIN", "&b<joined> &7has joined the &b<event_name> Event&8! &8(&b<event_participants_size>/<event_max_players>&8)"),
    EVENT_PLAYER_JOIN("EVENTS.PLAYER_JOIN", "&7[&a+&7] &7You have successfully joined the &b<event_name> Event&8!"),
    EVENT_LEAVE("EVENTS.LEAVE", "&b<left> &7has left the &b<event_name> Event&8! &8(&b<event_participants_size>/<event_max_players>&8)"),
    EVENT_PLAYER_LEAVE("EVENTS.PLAYER_LEAVE", "&7[&b-&7] &7You have successfully left the &b<event_name> Event&8!"),
    EVENT_NOTABLE_JOIN("EVENTS.NOT_ABLE_TO_JOIN", "&7You are not currently able to join the event!"),
    EVENT_ON_GOING("EVENTS.ON_GOING", "&7There is already an active &bEvent&7!"),
    EVENT_COOLDOWN_ACTIVE("EVENTS.COOLDOWN_ACTIVE", "&7There is an active cooldown for event. (Expires in: <expire_time>)!"),
    EVENT_NO_COOLDOWN("EVENTS.NO_COOLDOWN", "&7There is no currently active &bEvent cooldown."),
    EVENT_COOLDOW_RESET("EVENTS.COOLDOWN_RESET", "&7Successfully reset the &bEvent &7cooldown."),
    EVENT_ALREADY_STARTED("EVENTS.ALREADY_STARTED", "&7This event has already!"),
    EVENT_ELIMINATED("EVENTS.ELIMINATED", "&b<eliminated_name> &7was eliminated by &b<eliminator_name>&7!"),
    EVENT_DIED("EVENTS.DIED", "&b<eliminated_name> &7has died&7!"),
    EVENT_CANCELLED("EVENTS.CANCELLED", "&bThe <event_name> Event has been cancelled!"),
    EVENT_START_COUNTDOWN("EVENTS.START_COUNTDOWN", "&b<seconds>&f..."),
    EVENT_NOT_SETUP("EVENTS.NOT_SETUP", "&7The event you are trying to join is not correctly setup!"),
    EVENT_PARKOUR_WON("EVENTS.PARKOUR_WON", "&b<winner> &ehas reached the handleEnd!"),
    EVENT_ROUND_STARTED("EVENTS.ROUND_STARTED", "&bThe round has started!"),
    EVENT_STARTED("EVENTS.STARTED", "&bThe event has started!"),
    EVENT_NOT_TEAM("EVENTS.NOT_TEAM", "&7This event is not a team event!"),
    EVENT_FULL("EVENTS.FULL", "&bThis event is full on its player capacity!"),
    EVENT_FORCESTART("EVENTS.FORCESTART", "&7Successfully force started the &b<event_name> Event&7!"),
    EVENT_KNOCKBACK("EVENTS.KNOCKBACK", "&7Successfully updated the knockback profile to &b<knockback>"),
    EVENT_SPAWN("EVENTS.SPAWWN", "&7Updated &bEvent's &7spawn location &b<position>&7."),
    EVENT_TELEPORT("EVENTS.TELEPORT", "&7Teleported to &b<event_name>'s &7spawn location."),
    EVENT_STARTING("EVENTS.STARTING", "&fThe &b<event_name> &fEvent will start in &b10 seconds&f..."),
    EVENT_NOT_ENOUGH_PLAYERS("EVENTS.NOT_ENOUGH_PLAYERS", "&bThere are not enough players to start this event!"),
    EVENT_KILLED("EVENTS.KILLED", "&b<killed_name> &7has died!"),
    EVENT_NO_PERMISSION("EVENTS.NO_PERM", Legacy.asList(
            "&7You do not have permission to use this.",
            "&7&oPlease upgrade your RankType at &b&<store> &7")),
    EVENT_ANNOUNCE("EVENTS.ANNOUCE", Legacy.asList(" ",
            "&7\u2b1b\u2b1b\u2b1b\u2b1b\u2b1b\u2b1b\u2b1b\u2b1b",
            "&7\u2b1b\u2b1b&b\u2b1b\u2b1b\u2b1b\u2b1b&7\u2b1b\u2b1b &b&l[<event_name> Event]",
            "&7\u2b1b\u2b1b&b\u2b1b&7\u2b1b\u2b1b\u2b1b\u2b1b\u2b1b ",
            "&7\u2b1b\u2b1b&b\u2b1b\u2b1b\u2b1b\u2b1b&7\u2b1b\u2b1b &fA &b<event_name> &fevent is being hosted by &b<event_host>",
            "&7\u2b1b\u2b1b&b\u2b1b&7\u2b1b\u2b1b\u2b1b\u2b1b\u2b1b &fEvent is starting in 60 seconds!",
            "&7\u2b1b\u2b1b&b\u2b1b\u2b1b\u2b1b\u2b1b&7\u2b1b\u2b1b &a&l[Click to Join]",
            "&7\u2b1b\u2b1b\u2b1b\u2b1b\u2b1b\u2b1b\u2b1b\u2b1b", "")),
    ...
    EVENT_TEAM_WON("EVENTS.TEAM_WON", Legacy.asList(" ",
            ...
            "&7\u2b1b\u2b1b&b\u2b1b\u2b1b\u2b1b\u2b1b&7\u2b1b\u2b1b &b&l[<event_name> Event]",
            "&7\u2b1b\u2b1b&b\u2b1b&7\u2b1b\u2b1b\u2b1b\u2b1b\u2b1b ",
            "&7\u2b1b\u2b1b&b\u2b1b\u2b1b\u2b1b\u2b1b&7\u2b1b\u2b1b &b<winner> &ehas won the <event_name> Event.",
            "&7\u2b1b\u2b1b&b\u2b1b&7\u2b1b\u2b1b\u2b1b\u2b1b\u2b1b &7&oThe team consisted of the following players",
            "&7\u2b1b\u2b1b&b\u2b1b\u2b1b\u2b1b\u2b1b&7\u2b1b\u2b1b &7<players>",
            "&7\u2b1b\u2b1b\u2b1b\u2b1b\u2b1b\u2b1b\u2b1b\u2b1b",
            "")),
    EVENT_WON("EVENTS.WON", Legacy.asList(" ",
            ...
            "&7\u2b1b\u2b1b&b\u2b1b&7\u2b1b\u2b1b\u2b1b\u2b1b\u2b1b ",
            "&7\u2b1b\u2b1b&b\u2b1b\u2b1b\u2b1b\u2b1b&7\u2b1b\u2b1b &b<winner> &ehas won the <event_name> Event.",
            "&7\u2b1b\u2b1b&b\u2b1b&7\u2b1b\u2b1b\u2b1b\u2b1b\u2b1b &7&oGood game!", "&7\u2b1b\u2b1b&b\u2b1b\u2b1b\u2b1b\u2b1b&7\u2b1b\u2b1b",
            "&7\u2b1b\u2b1b\u2b1b\u2b1b\u2b1b\u2b1b\u2b1b\u2b1b",
            "")),
    EVENT_HELP("EVENTS.HELP", Legacy.asList(
            "&b&m--------&7&m-------------------------------------&b&m--------",
            "&bLegacy &7» Event Commands",
            "&b&m--------&7&m-------------------------------------&b&m--------",
            " &7* &b/event &8(&7&oView this message&8)",
            " &7* &b/event host &8(&7&oHost an Event&8)",
            " &7* &b/event forcestart &8(&7&oForcestart an active event&8) [ADMIN]",
            " &7* &b/event stop &8(&7&oStop an active event&8) [ADMIN]",
            " &7* &b/event join &8(&7&oJoin an active event&8)",
            " &7* &b/event leave &8(&7&oLeave an active event&8)",
            " &7* &b/event teamselect &8(&7&oView Team Selection Menu&8)",
            "&b&m--------&7&m-------------------------------------&b&m--------")),
    EVENT_INFO("EVENTS.INFO", Legacy.asList(
            "&b&m--------&7&m-------------------------------------&b&m--------",
            "&b<event_name> &7» Information",
            "&b&m--------&7&m-------------------------------------&b&m--------",
            " &7* &bState: &f<event_state>",
            " &7* &bHost: &f<event_host>",
            " &7* &bPlayers: &f<event_alive_players>&7/&f<event_max_players>",
            "&b&m--------&7&m-------------------------------------&b&m--------"
    )),

    KILL_EFFECT_SELECTED("KILL_EFFECT.SELECTED", "&7Successfully equipped &b<kill_effect> &7for your profile!"),
    KILL_EFFECT_ALREADY_SELECTED("KILL_EFFECT.ALREADY_SELECTED", "&7You have already selected that kill effect!"),
    KILL_EFFECT_NO_PERM("KILL_EFFECT.NO_PERMISSION", "&7You don't have permission to use this kill effect!\n&7&oPlease upgrade your core at &b<store>&7&o!"),

    XP_ADD("PROFILE.XP_ADD", "&7[&bXP&7] &fYou have been awarded &b<xp>&f!"),

    QUEUE_JOIN_UNRANKED("QUEUE.JOIN_UNRANKED", "&7You have been added to the &b<queue_name> &7queue."),
    QUEUE_JOIN_RANKED("QUEUE.JOIN_RANKED", "&7You have been added to the &b<queue_name> &7queue. &b[<queue_elo>]"),
    QUEUE_JOIN_CLAN("QUEUE.JOIN_CLAN", "&7You have been added to the &b<queue_name> &7queue. &b[<clan_elo>]"),
    QUEUE_LEAVE("QUEUE.LEAVE", "&7You left the <queue_name> queue."),

    DUEL_SENT("DUEL.SENT", "&7[&b&lDuel&7] &fYou sent a duel request to &b<target_name> &7(<target_ping>) &f with kit &b<duel_kit> &fon the arena &b<duel_arena>"),
    DUEL_RECEIVED("DUEL.RECEIVED", "&7[&b&lDuel&7] &b<sender_name> &7(<sender_ping>&7) &fhas sent you a duel request with kit &b<duel_kit> &fon the arena &b<duel_arena>"),
    DUEL_HOVER("DUEL.INVITE_HOVER", "&7Click to accept this duel."),
    DUEL_ACCEPT("DUEL.CLICK_TO_ACCEPT", "&a(Click to Accept)"),
    DUEL_ALREADYSENT("DUEL.ALREADY_SENT", "&7[&b&lDuel&7] &7You have already sent a duel to them!"),
    DUEL_DISBANDED("DUEL.DISBANDED", "&7[&b&lDuel&7] &7The party you were trying to duel has been disbanded!"),
    DUEL_NOT_PENDING("DUEL.NOT_PENDING", "&7[&b&lDuel&7] &7You don't have any pending requests from that player!"),

    KITEDITOR_LONG("KITEDITOR.TOO_LONG", "&7A name cannot be longer than &b16 &7characters!"),
    KITEDITOR_RENAMED("KITEDITOR.RENAMED", "&7Successfully &brenamed &7the kit to &b<custom_name>&7!"),
    KITEDITOR_RENAMING("KITEDITOR_RENAMING", "&7Renaming &b<old_name>&7, Enter the new name now..."),

    LEADERBOARDS_KIT_FORMAT("LEADERBOARDS.KIT_FORMAT", "&b<leaderboards_pos> &7&l\uff5c &f<leaderboards_name>: &b<leaderboards_elo> &7(<leaderboards_division>)"),
    LEADERBOARDS_GLOBAL_FORMAT("LEADERBOARDS.GLOBAL_FORMAT", "&b<leaderboards_pos> &7&l\uff5c &f<leaderboards_name>: &b<leaderboards_elo> &7(<leaderboards_division>)"),
    LEADERBOARDS_CLAN_FORMAT("LEADERBOARDS.CLAN_FORMAT", "&b<leaderboards_pos> &7&l\uff5c &f<leaderboards_name>: &b<leaderboards_elo> &7(<leaderboards_division>)");
